var qq = (function() {
    ...
    var qq_bootstrap_track = function(sound, track, success, failure, hm, se) {
        var target_url ='https://c.y.qq.com/base/fcgi-bin/fcg_music_express_mobile3.fcg?g_tk=195219765&jsonpCallback=MusicJsonCallback004680169373158849&loginUin=1297716249&hostUin=0&format=json&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0&cid=205361747&callback=MusicJsonCallback004680169373158849&uin=1297716249&songmid='+ track.id.slice('qqtrack_'.length) +'&filename=C400'+ track.id.slice('qqtrack_'.length) + '.m4a&guid=7332953645';
        ...
        .then(function(response) {
            ...
            var url = 'http://dl.stream.qqmusic.qq.com/C400' +  track.id.slice('qqtrack_'.length)  + '.m4a?vkey='+ token + '&uin=1297716249&fromtag=0&guid=7332953645';
            sound.url = url;
            success();
        });
    }
